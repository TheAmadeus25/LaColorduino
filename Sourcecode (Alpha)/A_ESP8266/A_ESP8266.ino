...
#define Trigger 19                                          // Ambilight Trigger in percent (1% - 100%)
...
struct {
  ...
  const long    change_delay = 5000;                        // ---5000
...
//----------------------------------------------------------------------------
struct {  // Pressed
  long Button_One;                                          // Hold|Release
  long Button_Two;                                          // Prev
  long Button_Three;                                        // Next
  byte Setting;                                             // 
  bool Enable;                                              // 
} Pressed;
//----------------------------------------------------------------------------
...
void loop() {
  ...
  if ( millis() - Setting.change_refresh > Setting.change_delay || Pressed.Button_Three == true) {
    switch(Device.Mode) {
      case 20:  Device.Mode = 30; Device.Set = 30;  break;
      case 30:  Device.Mode = 32; Device.Set = 32;  break; //---31|31
      case 31:  Device.Mode = 32; Device.Set = 32;  break;
      case 32:  Device.Mode = 40; Device.Set = 40;  break;
