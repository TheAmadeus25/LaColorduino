...
void Symbolic_WiFi(short wifi_state) {
  ...
  if ( (wifi_state >= 0 && wifi_state <= 2) || (wifi_state >= 6 && wifi_state <= 8) ) {
    GFX_HLine(3, 1, 4, 30, 30, 30);
    GFX_HLine(3, 0, 4, 255, 255, 255);
  }

  if ( (wifi_state >= 1 && wifi_state <= 3) || (wifi_state >= 7 && wifi_state <= 9) ) {
    GFX_HLine(3, 4, 4, 30, 30, 30);
    GFX_HLine(2, 3, 5, 30, 30, 30);
    GFX_HLine(3, 3, 4, 255, 255, 255);
  }

  if ( (wifi_state >= 2 && wifi_state <= 4) || (wifi_state >= 8 && wifi_state <= 10) ) {
...
void Symbolic_Power() {
  ...
  GFX_VLine(2, 7, 2, 255, 255, 0);

  Colorduino.SetPixel(3, 3, 255, 255, 0);

  Colorduino.SetPixel(4, 4, 255, 255, 0);
  Colorduino.SetPixel(4, 1, 255, 255, 0);

  GFX_VLine(5, 5, 0, 255, 255, 0);

  Colorduino.SetPixel(6, 1, 255, 255, 0);
...
void Symbolic_Check() {
  ...
  GFX_VLine(1, 3, 2, 0, 255, 0);
  GFX_VLine(2, 2, 1, 0, 255, 0);
  GFX_VLine(3, 3, 2, 0, 255, 0);
  GFX_VLine(4, 4, 3, 0, 255, 0);
  GFX_VLine(5, 5, 4, 0, 255, 0);
  GFX_VLine(6, 6, 5, 0, 255, 0);

  return;
}

void Symbolic_Sun(bool Rising) {
  if (Rising) {
    GFX_Square(3, 7, 4, 6, 255, 255, 0);
  } else {
    GFX_Square(3, 1, 4, 0, 255, 255, 0);
  }
