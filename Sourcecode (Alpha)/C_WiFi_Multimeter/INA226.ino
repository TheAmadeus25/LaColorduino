void InitINA() {
  ...
  // Configure INA226
  ina.configure(INA226_AVERAGES_4, INA226_BUS_CONV_TIME_204US, INA226_SHUNT_CONV_TIME_204US, INA226_MODE_SHUNT_BUS_CONT);
...
void GetINA() {
  Messuring.VBS = ina.readBusVoltage();
  Messuring.VPW = ina.readBusPower() / 10;
  Messuring.ShV = ina.readShuntVoltage();
  Messuring.ShA = ina.readShuntCurrent() / 10;
